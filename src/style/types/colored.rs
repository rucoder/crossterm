    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        ...
        if !fg {
            match color {
                ...
                Color::Red => f.write_str("1;5"),
                Color::DarkRed => f.write_str("1;25"),
                Color::Green => f.write_str("2;5"),
                Color::DarkGreen => f.write_str("2;25"),
                Color::Yellow => f.write_str("3;5"),
                Color::DarkYellow => f.write_str("3;25"),
                Color::Blue => f.write_str("4;5"),
                Color::DarkBlue => f.write_str("4;25"),
                Color::Magenta => f.write_str("5;5"),
                Color::DarkMagenta => f.write_str("5;25"),
                Color::Cyan => f.write_str("6;5"),
                Color::DarkCyan => f.write_str("6;25"),
                Color::White => f.write_str("7;5"),
                Color::Grey => f.write_str("7;25"),
            ...
            match color {
                ...
                Color::Red => f.write_str("1;1"),
                Color::DarkRed => f.write_str("1;22"),
                Color::Green => f.write_str("2;1"),
                Color::DarkGreen => f.write_str("2;22"),
                Color::Yellow => f.write_str("3;1"),
                Color::DarkYellow => f.write_str("3;22"),
                Color::Blue => f.write_str("4;1"),
                Color::DarkBlue => f.write_str("4;22"),
                Color::Magenta => f.write_str("5;1"),
                Color::DarkMagenta => f.write_str("5;22"),
                Color::Cyan => f.write_str("6;1"),
                Color::DarkCyan => f.write_str("6;22"),
                Color::White => f.write_str("7;1"),
                Color::Grey => f.write_str("7;22"),
                Color::Rgb { r, g, b } => write!(f, "2;{r};{g};{b}"),
                Color::AnsiValue(val) => write!(f, "5;{val}"),
                _ => Ok(()),
            }
